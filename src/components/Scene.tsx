...
export function Scene() {
  useEffect(() => {
    ...
    const build = () => {
      ...
      // Следом уходит и сам поток сцены: ниже его подхватывает поток
      // полотна, который идёт сквозь всю страницу и не обрывается.
      master.fromTo(
        '.hero__stage .steamgl, .hero__stage .flow',
        { autoAlpha: 1 },
        { autoAlpha: 0, duration: hf * 0.1 },
        hf * 0.9,
      )
