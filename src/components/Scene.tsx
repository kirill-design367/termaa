...
export function Scene() {
  useEffect(() => {
    ...
    const build = () => {
      ...
      // Имя и его отражение уходят вместе с фотографией и с тем же
      // масштабом: они лежат В кадре, а не поверх него. Раньше их не
      // вёл никто — фотография отступала вглубь, а слово стояло, и по
      // кадру шло расслоение.
      master.fromTo(
        '.hero__name',
        { yPercent: 0, opacity: 1, scale: 1 },
        { yPercent: -6, opacity: 0, scale: 1.06, duration: hf * 0.52 },
        hf * 0.06,
      )
