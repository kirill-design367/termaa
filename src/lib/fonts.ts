...
export const PAIRS: Pair[] = [
  {
    id: 'kudryashev',
    title: 'Kudryashev Display × Golos Text',
    display: 'kudryashev',
    displayWeight: 400,
    text: 'golos',
    foundry: 'ParaType',
    designer: 'Ольга Умпелева, Изабелла Чаева, Александра Королькова',
    link: 'https://www.paratype.ru/fonts/pt/kudryashev-display',
    price: 'Куплена арт-директором, файлы переданы архивом',
    licence: 'Коммерческая лицензия ParaType',
    cyr: 'Проверено по таблице cmap в бинарнике: кириллица полная, 66 из 66 знаков — А–Я, а–я, ё, плюс № ₽ ° и тире. Гарнитура кириллическая по происхождению, латиница здесь вторична.',
    rationale:
      ...
      'читается спокойнее. Golos Text остаётся на всём остальном тексте: ' +
      'нейтральный гротеск под сверхконтрастной антиквой — рабочая пара, ' +
      'где каждая гарнитура делает ровно своё.',
  },
  {
    id: 'unbounded',
